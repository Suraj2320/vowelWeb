...
export const getCartItems = () => async(dispatch) => {
 ...
 try{
    let res=await axios.get(`https://surajinter.onrender.com/cart/get`)
...
console.log(cartInfo)
  ...
  try{
let res=await  axios.post("https://surajinter.onrender.com/cart/post", {...cartInfo,count:1} )
...
export const removeItemFromCart = (cartId) => (dispatch) => {
  ...
  return axios
    .delete(`https://surajinter.onrender.com/cart/${cartId}`)
    .then((r) => {
...
try{
let res=await axios.put(`https://surajinter.onrender.com/cart/${cartId}`,update)
...
export const alldlt=()=>async (dispatch)=>{
  try{
let res=await axios.delete(`https://surajinter.onrender.com/cart/`)
console.log(res)
dispatch(getCartItems())
  }
  catch(e){
